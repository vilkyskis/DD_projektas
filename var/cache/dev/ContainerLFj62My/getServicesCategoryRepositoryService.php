...
// Returns the private 'App\Repository\ServicesCategoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ServicesCategoryRepository.php';

return $this->privates['App\Repository\ServicesCategoryRepository'] = new \App\Repository\ServicesCategoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
