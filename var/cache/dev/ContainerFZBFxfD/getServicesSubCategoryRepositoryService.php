...
// Returns the private 'App\Repository\ServicesSubCategoryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ServicesSubCategoryRepository.php';

return $this->privates['App\Repository\ServicesSubCategoryRepository'] = new \App\Repository\ServicesSubCategoryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
