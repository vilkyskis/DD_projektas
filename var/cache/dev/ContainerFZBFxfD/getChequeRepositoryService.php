...
// Returns the private 'App\Repository\ChequeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ChequeRepository.php';

return $this->privates['App\Repository\ChequeRepository'] = new \App\Repository\ChequeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
