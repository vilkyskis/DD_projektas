...
// Returns the private 'App\Repository\CarsModelRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CarsModelRepository.php';

return $this->privates['App\Repository\CarsModelRepository'] = new \App\Repository\CarsModelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
