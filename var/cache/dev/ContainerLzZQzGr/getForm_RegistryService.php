...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\CarRegistrationType' => function () {
    return ($this->privates['App\Form\CarRegistrationType'] ?? $this->privates['App\Form\CarRegistrationType'] = new \App\Form\CarRegistrationType());
}, 'App\\Form\\CarsBrandType' => function () {
    return ($this->privates['App\Form\CarsBrandType'] ?? $this->privates['App\Form\CarsBrandType'] = new \App\Form\CarsBrandType());
}, 'App\\Form\\CarsModelType' => function () {
    return ($this->privates['App\Form\CarsModelType'] ?? $this->privates['App\Form\CarsModelType'] = new \App\Form\CarsModelType());
