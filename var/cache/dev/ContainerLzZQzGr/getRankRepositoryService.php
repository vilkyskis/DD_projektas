...
// Returns the private 'App\Repository\RankRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RankRepository.php';

return $this->privates['App\Repository\RankRepository'] = new \App\Repository\RankRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
