 ...
 */
class srcDoctrineDebugProjectContainer extends Container
{
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/srcDoctrineDebugProjectContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'srcDoctrineDebugProjectContainer',
            ...
            'router.cache_class_prefix' => 'srcDoctrineDebugProjectContainer',
