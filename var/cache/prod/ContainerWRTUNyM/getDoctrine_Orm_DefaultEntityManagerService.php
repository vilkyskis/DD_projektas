...
$d->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\AddressRepository' => function () {
...
}, 'App\\Repository\\CarsBrandRepository' => function () {
    return ($this->privates['App\Repository\CarsBrandRepository'] ?? $this->load('getCarsBrandRepositoryService.php'));
}, 'App\\Repository\\CarsModelRepository' => function () {
    return ($this->privates['App\Repository\CarsModelRepository'] ?? $this->load('getCarsModelRepositoryService.php'));
}, 'App\\Repository\\ChequeRepository' => function () {
    return ($this->privates['App\Repository\ChequeRepository'] ?? $this->load('getChequeRepositoryService.php'));
...
}, 'App\\Repository\\RankRepository' => function () {
    return ($this->privates['App\Repository\RankRepository'] ?? $this->load('getRankRepositoryService.php'));
}, 'App\\Repository\\ServiceRepository' => function () {
    return ($this->privates['App\Repository\ServiceRepository'] ?? $this->load('getServiceRepositoryService.php'));
}, 'App\\Repository\\ServicesCategoryRepository' => function () {
    return ($this->privates['App\Repository\ServicesCategoryRepository'] ?? $this->load('getServicesCategoryRepositoryService.php'));
}, 'App\\Repository\\ServicesSubCategoryRepository' => function () {
    return ($this->privates['App\Repository\ServicesSubCategoryRepository'] ?? $this->load('getServicesSubCategoryRepositoryService.php'));
...
}, 'App\\Repository\\VisitRepository' => function () {
    return ($this->privates['App\Repository\VisitRepository'] ?? $this->load('getVisitRepositoryService.php'));
}))));
