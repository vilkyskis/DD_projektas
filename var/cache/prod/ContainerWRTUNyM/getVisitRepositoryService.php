...
// Returns the private 'App\Repository\VisitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VisitRepository.php';

return $this->privates['App\Repository\VisitRepository'] = new \App\Repository\VisitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
