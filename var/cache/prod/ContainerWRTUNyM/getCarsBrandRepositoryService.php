...
// Returns the private 'App\Repository\CarsBrandRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CarsBrandRepository.php';

return $this->privates['App\Repository\CarsBrandRepository'] = new \App\Repository\CarsBrandRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
