...
class ProfileController extends Controller
{
     ...
     * Show the user.
     */
    public function showAction(CarRepository $carRepository)
    {
        $user = $this->getUser();
    ...
    /**
     * @Route("/cars", name="profile_cars", methods="GET")
     */
    public function showCars(CarRepository $carRepository): Response
    {
        return $this->render('admin/car_show.html.twig', ['cars' => $carRepository->findAll()]);
    }
}
