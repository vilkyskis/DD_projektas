 ...
 */
class Version20180407095048 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, car_id INT NOT NULL, cheque_id INT DEFAULT NULL, status VARCHAR(32) NOT NULL, INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F5299398C3C6F69F (car_id), UNIQUE INDEX UNIQ_F52993983DD3DB4B (cheque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
